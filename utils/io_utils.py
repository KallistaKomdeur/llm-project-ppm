...
def get_input() -> tuple:
    ...
    parser.add_argument("configuration", type=str, choices=["single_1", "single_ref", "inter-case_1", "single_split_1", "inter-case_split_1"], help="Which input configuration to use")
    # Optional
