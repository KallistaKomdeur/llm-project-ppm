...
def get_input() -> tuple:
    ...
    parser.add_argument("configuration", type=str, choices=["single_ref","inter-case_ref","single_split_ref","inter-case_split_ref", "single_exact"], help="Which input configuration to use")
    # Optional
